  ...
  return (
    <div className='py-5 px-5 md:[x-12 lg:px-28'>
        <div className='flex justify-between items-center'>
            ...
            <button className='flex items-center gap-2 font-medium py-1 px-3 sm:px-6 border border-solid border-black shadow-[-7px_7px_0px_#000000]'>Get Started <Image src={assets.arrow}></Image></button>
        </div>
        <div className='text-center my-8'>
            <h1 className='text-3xl sm:text-5xl font-medium'>Latest Blogs</h1>
            <p className='mt-5 max-w-[740px] m-auto text-xs sm:text-base'>Have Fun! Your Daily Dose of Curiosity and Creativity.</p>
