...
const page = ({params}) => {
  ...
  return (data?<>
    <div className='bg-gray-200 py-5 px-5 md:[x-12 lg:px-28'>
    ...
    <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
        ...
        <p className='my-3'>Some matter we need</p>
        <p className='my-3'>Some matter we need</p>
        <h3 className='my-5 text-[18px] font-semibold'>Step 1:</h3>
        <p className='my-3'>Some matter we need</p>
        <p className='my-3'>Some matter we need</p>
        ...
        <p className='my-3'>Some matter we need</p>
        <div className='my-24'>
            <p className='text-black font font-semibold my-4'>Share this article if you find interesting.</p>
            <div className='flex'>
